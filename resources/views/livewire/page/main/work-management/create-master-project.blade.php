<div class="space-y-6">
    <div>
        ...
        <p class="text-sm text-gray-500">Buat proyek utama perusahaan.</p>
    </div>
    ...
    <form wire:submit="save" class="space-y-4 rounded-xl border border-gray-200 bg-white p-6">
        <div>
            <label for="name" class="mb-1 block text-sm font-medium">Nama proyek</label>
        ...
        <div class="flex gap-3">
            <a href="{{ route('work-management.master-projects') }}" class="rounded-lg border px-4 py-2 text-sm">Batal</a>
