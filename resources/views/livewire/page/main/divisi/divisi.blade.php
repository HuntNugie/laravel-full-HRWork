                ...
                <x-wirekit::table alpine-sort hoverable>
                    <x-wirekit::table.head>
                        <x-wirekit::table.row>
                            ...
                            <x-wirekit::table.th sortable column="teams">
                                Teams
                            </x-wirekit::table.th>
                            ...
                            <x-wirekit::table.row>
                                <x-wirekit::table.td>
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#92EEFF]/40"
                                        >
                                            <x-wirekit::icon
                                ...
                                <x-wirekit::table.td>
                                    <div class="min-w-0">
                                        <p class="text-sm font-medium text-slate-700">
                                            {{ $divisi->manager?->user?->name ?? '—' }}
                                        </p>
                                        <p class="text-xs text-slate-400">
                                            {{ $divisi->manager?->position?->name ?? 'Manager belum ditentukan' }}
                                        </p>
                                    </div>
                                </x-wirekit::table.td>
