        ...
        @php
            $cards = [
                ...
                [
                    'key' => 'late',
                    'title' => 'Terlambat',
                    'description' => 'Masuk melewati batas',
                    'icon' => 'warning',
                ...
                [
                    'key' => 'absence',
                    'title' => 'Sakit / Izin',
                    'description' => 'Ketidakhadiran resmi',
                    'icon' => 'file-text',
                ...
                [
                    'key' => 'unpresent',
                    'title' => 'Belum Hadir',
                    'description' => 'Hari kerja tanpa presensi',
                    'icon' => 'close',
                ...
                [
                    'key' => 'pending',
                    'title' => 'Menunggu',
                    'description' => 'Hari kerja belum selesai',
                    'icon' => 'clock',
        ...
        <x-wirekit::card.body>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-5">
                ...
                <div>
                    ...
                    <x-wirekit::input wire:model.live.debounce.400ms="search" placeholder="Nama atau kode employee"
                        name="search" />
                ...
                <div>
                    ...
                    <select wire:model.live="divisiId"
                        class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-700 outline-none focus:border-[#30AFFF] focus:ring-2 focus:ring-[#30AFFF]/20">
                            ...
                            <x-wirekit::table.row>
                                ...
                                <x-wirekit::table.td>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div
                                            class="flex size-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-sky-100">

                                            @if ($row['avatar'])
                                                <img src="{{ $row['avatar'] }}" alt="{{ $row['employee_name'] }}"
                                ...
                                <x-wirekit::table.td align="right">
                                    ...
                                    <livewire:components.main.attendances.modal-detail-daily-status :row="$row"
                                        :key="'daily-status-detail-' .
                                            $row['state']['employee_id'] .
                                            '-' .
                                            $row['state']['date']">
